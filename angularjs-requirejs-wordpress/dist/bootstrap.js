...
define('angular-route', ['angular'], function () {
    (function (window, angular, undefined) {
        'use strict';
        var ngRouteModule = angular.module('ngRoute', ['ng']).provider('$route', $RouteProvider).run([
                '$route',
                angular.noop
...
define('controllers/my-ctrl-1', ['controllers/module'], function (controllers) {
    'use strict';
    controllers.controller('MyCtrl1', [function ($scope) {
        }]);
});
define('controllers/my-ctrl-2', ['controllers/module'], function (controllers) {
    'use strict';
...
define('directives/app-version', ['directives/module'], function (directives) {
    'use strict';
...
define('directives/index', ['directives/app-version'], function () {
});
define('filters/module', ['angular'], function (ng) {
    'use strict';
    return ng.module('app.filters', []);
});
define('filters/interpolate', ['filters/module'], function (filters) {
    'use strict';
...
define('filters/index', ['filters/interpolate'], function () {
});
define('services/module', ['angular'], function (ng) {
    'use strict';
    return ng.module('app.services', []);
});
define('services/version', ['services/module'], function (services) {
    'use strict';
    services.value('version', '0.1');
});
define('services/index', ['services/version'], function () {
});
define('app', [
    'angular',
    'angular-route',
...
require(['init']);
define('bootstrap', ['init'], function () {
    return;
});